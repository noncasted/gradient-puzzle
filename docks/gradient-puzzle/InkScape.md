...
export-png-antialias:  Set antialiasing level for PNG export
export-png-color-mode:  Set color mode for PNG export
export-png-compression:  Set compression level for PNG export
...
list-input-types    :  Print a list of input file extensions and exit
...
page-rotate         :  Rotate page by 90-degree rotation steps

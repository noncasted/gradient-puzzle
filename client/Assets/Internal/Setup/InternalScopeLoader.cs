    ...
    public class InternalScopeLoader
    {
        ...
        public ILoadedScope Load()
        {
            ...
            void Register(IContainerBuilder containerBuilder)
            {
                ...
                var platformOptions = new PlatformOptions(_config.Platform, Application.isMobilePlatform);
                optionsRegistry.AddOptions(platformOptions);

                containerBuilder.RegisterInstance(platformOptions);

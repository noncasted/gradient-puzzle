...
namespace VContainer.Unity
{
    ...
    public static class ContainerBuilderUnityExtensions
    {
        ...
        {
            var registrationBuilder = new ComponentRegistrationBuilder(component, Lifetime.Singleton).As(typeof(TInterface));
            ...
            Type type)
        {
            ...
            var registrationBuilder = new ComponentRegistrationBuilder(scene, type, Lifetime.Singleton);
            // Force inject execution

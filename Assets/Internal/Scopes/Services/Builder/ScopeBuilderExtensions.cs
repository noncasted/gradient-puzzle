...
namespace Internal
{
    public static class ScopeBuilderExtensions
    {
        ...
        public static IRegistration RegisterInstance<T>(this IScopeBuilder builder, T instance)
        {
            return new ScopeBuilderRegistration(builder, builder.Services.RegisterInstance(instance));
        }

        public static IRegistration RegisterComponent<T>(this IScopeBuilder builder, T component) where T : Object
        {
            return new ScopeBuilderRegistration(builder, builder.Services.RegisterComponent(component));
        }
